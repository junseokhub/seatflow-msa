...
// ShowCreatedEventConsumer.consume() 수정.
// JSON 문법은 맞지만 필수 필드(showDate,grades)가 비어있는 의미적으로 불완전한 메시지가 malformed 체크를 통과해버리고,
// SeatGenerationService까지 넘어가 NPE를 내는 문제를 발견했다.
